...
public class RestController {
	...
	List<Proyectos> getProyectos() {
        ...
        /*
            LOS PROYECTOS EN CURSO SON LOS QUE Aï¿½N LE QUEDAN ACTIVIDADES POR FINALIZAR 
        */
	...
	Integer getProjectIdCieloByReferencia(@PathVariable("ref") Integer referencia) {
        ...
        //POR LA DEFINICIï¿½N DE RESTRICCIONES DE LA BASE DE DATOS NO HABRï¿½ ACTIVIDADES DUPLICADAS (REF PROYECTO y CODIGO ACTIVIDAD)
        //CREAMOS UN EVENTO POR CADA ACTIVIDAD QUE NO TENGA EVENTO, TODO: OPTIMIZAR CON UNA CONSULTA CRITERIA o CON CONSULTA QUE COMPRUEBA SI EXISTE ALGï¿½N EVENTO DEL PROYECTO
	...
	Status updateEvento(@RequestBody Eventos evento) {
        ...
        /*
            OBTENER LISTADO DE EVENTOS SEGï¿½N LA ACTIVIDAD, OK
        */
	...
	List<Eventos> getEventoByActividad(@PathVariable("id") long id, @PathVariable("usuario") String nombre) {
        ...
        NOTA: Actualmente utilizamos este mï¿½todo para encontrar el ï¿½ltimo evento porque 
        android nos devuelve un error al encontrar un ï¿½nico elemento (devolvemos una lista)
        */
