...
public class Barras implements Serializable, Comparable<Barras> {
    ...
    private Integer mochilificada;      //Relaciï¿½n de barra necesidad con stockbarras. 0 (no hay relaciï¿½n), 1 (relaciï¿½n 1 a 1), +2 (de muchos a uno). Para descuento de stock sï¿½lo es vï¿½lido el valor 1.
    @Column(name = "grupo_stock")
    private Integer grupoStock;     //Cuando es barra nueva 0, cualquier otro caso relaciï¿½n con el grupo ID.
