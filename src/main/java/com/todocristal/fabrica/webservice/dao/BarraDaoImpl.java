...
public class BarraDaoImpl implements BarraDao {
    ...
    /*
        --------   OBTENEMOS INFORMACI�N SEG�N LA REFERENCIA, AS� PODEMOS OBTENER EL ID PARA TRATAR EL PROYECTO Y LAS TAREAS.
        EN LA SINCRONIZACI�N.
    */
    @Override
            ...
            switch (tipoSistema) {
                case "CORTINA_STATUS":
                    ...
                    if (status10mm){
                        ...
                        auxColores.add("7035"); // A�adido 121121
                        auxColores.add("7016"); // a�adido 121121
                        ...
                        auxColores.add("ES0006"); // A�ADIDO AL MOCHI EL 06102025 
